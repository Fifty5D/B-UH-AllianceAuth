...
TAX_WHEEL="aa_buh_moon_tax-0.3.1-py3-none-any.whl"
...
TAX_SHA256="ac9d7a8241a520c9f5608cd6fbf73d684b1bd3060ae4e6d68b46b05e30cdfb75"
...
cleanup() {
    case "$0" in
        /tmp/buh-moon-tax-platform-remote-v0.3.2.sh)
            rm -f -- "$0" \
...
COPY conf/aa_buh_moon_tax-0.3.1-py3-none-any.whl /tmp/
RUN python3 -m pip install --no-cache-dir --upgrade \\
    ...
    /tmp/aa_buh_moon_tax-0.3.1-py3-none-any.whl
...
verify_image_versions() {
    ...
    expected="5.2.0|9.6.0|5.0.4|4.0.3|3.1.0.post1|0.3.0|0.2.0|0.3.1"
    for service in "${AUTH_SERVICES[@]}"; do
        output="$({
