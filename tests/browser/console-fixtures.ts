...
export type ConsoleApp = "moon-tax" | "structure-operations" | "schedule" | "archive" | "vps";
...
export async function openConsole(page: Page, app: ConsoleApp) {
  ...
  const path = app === "moon-tax" ? "/moon-tax/" : app === "schedule"
  ...
  const root = app === "moon-tax" ? "#moon-tax-app" : app === "archive" ? "#buh-archive"
